...
class TestRetryMechanism(unittest.TestCase):
    ...
    def test_retry_success_first_try(self):
        ...
        self.assertEqual(
            result.standardized_response["content"], "Success on first try"
        )
    ...
    def test_retry_success_after_retries(self):
        ...
        self.assertTrue(result.success)
        self.assertEqual(
            result.standardized_response["content"], "Success after retries"
        )
    ...
    def test_retry_backoff_calculation(self):
        ...
        responses = [
            LLMResponse(
                success=False, error_info={"message": "Error 1"}, is_retryable=True
            ),
            LLMResponse(
                success=False, error_info={"message": "Error 2"}, is_retryable=True
            ),
    ...
    def test_retry_quiet_by_default(self):
        ...
        responses = [
            LLMResponse(
                success=False, error_info={"message": "Retry me"}, is_retryable=True
            ),
