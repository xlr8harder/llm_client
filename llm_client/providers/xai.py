...
class XAIProvider(LLMProvider):
    """Provider implementation for X.AI API (OpenAI-compatible)"""
    ...
    def make_chat_completion_request(self, messages, model_id, context=None, **options):
        """
        Make a request to the X.AI API

        Args:
            messages: List of message objects with 'role' and 'content' keys
            model_id: X.AI model identifier
    ...
    def _standardize_response(self, provider_response):
        """Convert X.AI response to standardized format"""
        standardized = {
